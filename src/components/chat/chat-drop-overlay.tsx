  ...
  return (
    ...
    >
      <div className="flex h-full flex-col items-center justify-center p-8 text-center">
        <div className="relative mb-7 h-20 w-32 animate-in duration-200 fade-in-0 slide-in-from-bottom-2" aria-hidden>
          <div
            ...
            style={{ backgroundColor: "color-mix(in oklab, var(--primary) 68%, white)" }}
          >
          ...
          <div
            ...
            style={{ backgroundColor: "color-mix(in oklab, var(--primary) 84%, white)" }}
          >
        ...
        <p className="text-2xl font-semibold tracking-tight">Lägg till vad som helst</p>
        <p className="mt-2 text-base text-muted-foreground">Släpp en fil här för att lägga till den i chatten</p>
      </div>
    </div>
  );
}
